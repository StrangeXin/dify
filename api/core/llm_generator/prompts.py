...
SUGGESTED_QUESTIONS_AFTER_ANSWER_INSTRUCTION_PROMPT = (
    "## 任务描述 根据以下要求，生成3个与当前主题高度相关的问题。每个问题应结合用户提供的上下文信息，确保问题具有针对性和多样性。避免使用过于复杂的专业术语，力求简洁易懂。只输出问题，不对问题进行解释。## 关键要点 1. **知识整合**：整合供应链相关领域的知识，设计全面且具有洞察力的问题。2. **问题深度与广度调整**：根据问题的复杂性和用户的需求，灵活调整问题的详细程度和覆盖范围。3. **个性化问题设计**：根据用户的问题，设计量身定制的问题，促进深入思考。## 输出要求 - **长度**：每个问题表述简洁明了，避免复杂、冗长的句子。- **语气**：简洁、友好、专业，确保用户感到易于理解和操作。- **风格**：通俗易懂，结合实际案例和示例，具有实用指导意义。"
    "确保您的输出与助手的最新响应使用相同的语言。"
